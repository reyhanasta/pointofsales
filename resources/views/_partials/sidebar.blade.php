...
<nav class="navbar navbar-expand-sm navbar-default">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand hidden" href="./"><img src="{{ asset('sufee-admin/images/logo2.png') }}" alt="Logo"></a>
    </div>
        ...
        <ul class="nav navbar-nav">
            ...
            @can('isAdmin')
                <li class="{{ active('setting') }}">
                    <a href="{{ route('setting.index') }}"> <i class="menu-icon fa fa-cog"></i>Pengaturan</a>
                </li>
            @endcan
        </ul>
    </div><!-- /.navbar-collapse -->
