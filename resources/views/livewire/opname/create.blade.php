<div class="col-sm-4">
    <form class="card" wire:submit.prevent="save">
        <div class="card-header">
            <h2 class="card-title h6 mb-0 font-weight-bold">Tambah Data</h2>
        </div>
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Nama Barang" name="judul" disabled>
            </div>
            <div class="form-group">
                <label>Stok Sistem</label>
                <input type="text" class="form-control" placeholder="Stok" name="stock" disabled>
            </div>
            <div class="form-group">
                <label>Harga Pokok</label>
                <input type="text" class="form-control" placeholder="Harga Pokok" name="hargaPokok" disabled>
            </div>
            <div class="form-group">
                <label>Stok Nyata</label>
                <input type="number" class="form-control @error('stokNyata') is-invalid @enderror" placeholder="Stok Nyata" wire:model.defer="stokNyata">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('keterangan') is-invalid @enderror" placeholder="Keterangan" wire:model.defer="keterangan"></textarea>
