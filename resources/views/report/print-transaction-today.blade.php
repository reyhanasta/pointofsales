...
<hr>
    ...
    <div class="heading" style="margin-bottom: 20px">
        <p class="sub">Laporan Pendapatan Harian</p>
    </div>
    ...
    <table width="100%" style="border-collapse: collapse;">
        <thead style="background-color: #111; color: #fff">
            <tr>
                ...
                <td style="font-weight: bold; border: 1px solid #111; padding: 5px 10px">Jam</td>
        ...
        <tbody>
            ...
            @endphp
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #111; padding: 5px 10px">
                        {{ date('H:i A', strtotime($report->tanggal)) }}
                    </td>
                    <td style="border: 1px solid #111; padding: 5px 10px">
                        {{ $report->idPenjualan }}
                    </td>
                ...
                @endforeach
                <tr>
                    <td style="border: 1px solid #111; padding: 5px 10px" align="center" colspan="3">Total Pendapatan Harian</td>
                    <td style="border-bottom: 1px solid #111; padding: 5px 10px" width="1%">Rp.</td>
                    <td style="border: 1px solid #111; border-left: none; padding: 5px 10px" width="15%" align="right">{{ number_format($total) }}</td>
                </tr>
        </tbody>
    </table>
