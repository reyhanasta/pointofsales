        ...
        <tbody>
            ...
            @if (count($expend))
                ...
                <tr>
                    ...
                    <td></td>
                    <td>Rp.</td>
                    <td align="right">{{ number_format($reports->pengeluaran ?? 0) }}</td>
                </tr>
            @else
                <tr>
                    <td colspan="2">
                    ...
                    <td>Rp.</td>
                    <td align="right">
                        {{ number_format($reports->pengeluaran ?? 0) }}
                    </td>
                </tr>
            @endif
            <tr>
                ...
                <td width="1%" style="position: relative;">
                    <span style="position: absolute; top: -8px; right: 0;">-</span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                <td>Rp.</td>
                <td align="right">
                    {{ number_format($reports->labaKotor ?? 0) }}
                </td>
            </tr>
        </tbody>
    </table>
