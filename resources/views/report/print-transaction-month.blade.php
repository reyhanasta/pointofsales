...
<hr>
    ...
    <div class="heading" style="margin-bottom: 20px">
        <p class="sub">Laporan Pendapatan Bulanan</p>
    </div>
            ...
            @endphp
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #111; border-left: none; padding: 5px 10px" width="15%" align="right">
                        Rp {{ number_format($report->total) }}
                    </td>
                </tr>
                @endforeach
                <tr>
                    <td style="border: 1px solid #111; padding: 5px 10px" align="right" colspan="2">Total Pendapatan Bulanan</td>
                    <td style="border-bottom: 1px solid #111; padding: 5px 10px" width="1%">Rp.</td>
